...
const ja = {
  ...
  'detail.matchups': 'タイプそうせい',
  'detail.weaknesses': 'じゃくてん',
  'detail.resistances': 'たいせい',
  'detail.immunities': 'むこう',
  'detail.matchupsNone': 'なし',
...
const en: MessageDictionary = {
  ...
  'detail.weaknesses': 'Weak to',
  'detail.resistances': 'Resists',
  'detail.immunities': 'Immune to',
  'detail.matchupsNone': 'None',
